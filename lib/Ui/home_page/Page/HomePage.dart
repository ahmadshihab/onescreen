...
class _HomePageState extends State<HomePage> {
  final List<String> colList = ['0xffF03E3E', '0xff3AAD17', '0xff1762AD'];
  int _current = 0;
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                          padding: EdgeInsets.only(
                                              ...
                                              bottom: 10),
                                          child: Text(
                                            'Une journée avec Yacouba Sawadogo,  l’homme qui a fait reculer le désert.',
                                            style: TextStyle(
                                                color: Colors.white,
                                                fontFamily: 'Montserrat',
                                                fontWeight: FontWeight.bold,
